...
if(isset($_POST['submit']))
{
  ...
  else if($_POST['submit']==="register")
  {
        ...
        {
          $query ="INSERT INTO users VALUES ('$username','$password','client')";
          $result=mysqli_query($conn,$query);
          print'
  ...
  <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
      <div class="container-fluid">
        ...
        if(!isset($_SESSION['user']))
          ...
          {
               echo ($_SESSION['user']['role']=="admin" ? '<li> <a href="/admin" class="btn btn-lg">Admin</a> </li>; ' : '');
                echo' <li> <a href="/profile?user='.$_SESSION['user']['username'].'" class="btn btn-lg">Profile</a></li>
